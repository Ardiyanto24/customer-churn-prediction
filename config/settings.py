...
# =============================================================================
# Konstanta ini mendefinisikan kriteria quality gate untuk memutuskan apakah
# sebuah model boleh (pass) dilanjutkan ke tahap berikutnya berdasarkan analisis SHAP.
...
# Contoh: Dengan 5 expected features dan threshold 0.5, minimal 3 dari 5
# harus masuk ke dalam top-10 SHAP agar model dinyatakan lulus quality gate.
XAI_MIN_OVERLAP = 0.5
